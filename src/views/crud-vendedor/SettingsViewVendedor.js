...
const SettingsViewVendedor = ({ showNotification }) => {
  ...
  // Datos de ejemplo (en una aplicación real, estos vendrían de props o de un estado global)
  const mockData = {
    usuarios: [
...
export default SettingsViewVendedor;